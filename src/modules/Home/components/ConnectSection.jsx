...
const ConnectSection = ({ leftImageUrl, rightImageUrl }) => {
    return (
        <div className="w-full h-auto section flex flex-col md:flex-row items-center justify-between px-4"
        style={{
            ...
            >
                <div className="text-white text-center md:text-left mb-6 md:mb-0 md:mr-8">
