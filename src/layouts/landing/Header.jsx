...
const NavBar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white text-black' : 'bg-transparent text-white'
      }`}>
      <div className="Resizer">
        <div className="sm:px-6 flex items-center justify-between h-16 py-10 relative">
          ...
          {/* Consultant Button (Outside Nav Background) */}
          ...
          <div className="md:hidden">
            <button onClick={toggleMobileMenu} className="text-pink-600 hover:text-pink-600 px-3 py-2 rounded-md text-sm font-medium">
